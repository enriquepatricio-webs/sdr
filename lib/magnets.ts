...
export function promptDeEntrega(opciones: {
  ...
  return [
    ...
    "",
    `El recurso es esto y va TAL CUAL, sin cambiar ni una letra: ${opciones.recurso}`,
    "",
    "CÓMO ESCRIBIR:",
    "",
    "· Como le hablarías a alguien de doce años. Si una frase necesita releerse,",
    "  está mal escrita. El lenguaje técnico no da profesionalidad, da pereza.",
    "",
    "· Sin adjetivos y sin venderlo. Nada de «potente», «brutal», «espero que te",
    "  sirva». Lo que has mandado se defiende solo o no se defiende.",
    "",
    "· Quítale trabajo. Si puedes decirle por dónde empezar o cuánto le va a",
    "  llevar, dilo: lo que decide si algo se usa no es lo bueno que es, es lo",
    "  poco que cuesta empezarlo.",
    "",
    "· No pidas nada. Ni que comparta, ni que te siga, ni que te cuente qué le",
    "  parece la marca. Acaba de pagarte con su atención; cóbrale otra vez ahora",
    "  y se acabó la conversación.",
    "",
    "LA PREGUNTA DEL FINAL:",
    "",
    "Cierra con UNA pregunta corta, fácil de contestar, y sobre ÉL, no sobre el",
    "recurso. No «¿qué te parece?» —eso obliga a haberlo leído y a opinar—, sino",
    "algo de su situación que se conteste en tres palabras.",
    "",
    "Esa pregunta no es cortesía: lo que acabas de resolverle es un problema",
    "pequeño, y resolverlo deja a la vista el siguiente. La pregunta sirve para",
    "que sea ÉL quien lo nombre. Ahí empieza la conversación de verdad.",
    "",
