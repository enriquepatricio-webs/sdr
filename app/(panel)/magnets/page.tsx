  ...
  const [imanes, cuentas] = await Promise.all([
    ...
    db
      .select({
        ...
        // Sin token de Meta el imán no puede leer ni un comentario. Ofrecer esa
        // cuenta es dejar crear algo que nace muerto y no dice por qué.
        autorizada: accounts.metaToken,
      })
      .from(accounts)
      .where(
        and(
